...
export const testerCharacterKeys = [
  '_Test_A_Swo',
  '_Test_G_Swo',
  '_Test_E_Swo',
  '_Test_D_Swo',
...
export type TesterCharacterKey = (typeof testerCharacterKeys)[number]

export const testerCharacterKeysMap = {
  _Test_A_Swo: { key: '_Test_A_Swo', ele: 'anemo', weaponType: 'sword'},
  _Test_G_Swo: { key: '_Test_G_Swo', ele: 'geo', weaponType: 'sword'},
  _Test_E_Swo: { key: '_Test_E_Swo', ele: 'electro', weaponType: 'sword'},
  _Test_D_Swo: { key: '_Test_D_Swo', ele: 'dendro', weaponType: 'sword'},
  _Test_H_Swo: { key: '_Test_H_Swo', ele: 'hydro', weaponType: 'sword'},
  _Test_P_Swo: { key: '_Test_P_Swo', ele: 'pyro', weaponType: 'sword'},
  _Test_C_Swo: { key: '_Test_C_Swo', ele: 'cryo', weaponType: 'sword'},
  _Test_A_Cla: { key: '_Test_A_Cla', ele: 'anemo', weaponType: 'claymore'},
  _Test_G_Cla: { key: '_Test_G_Cla', ele: 'geo', weaponType: 'claymore'},
  _Test_E_Cla: { key: '_Test_E_Cla', ele: 'electro', weaponType: 'claymore'},
  _Test_D_Cla: { key: '_Test_D_Cla', ele: 'dendro', weaponType: 'claymore'},
  _Test_H_Cla: { key: '_Test_H_Cla', ele: 'hydro', weaponType: 'claymore'},
  _Test_P_Cla: { key: '_Test_P_Cla', ele: 'pyro', weaponType: 'claymore'},
  _Test_C_Cla: { key: '_Test_C_Cla', ele: 'cryo', weaponType: 'claymore'},
  _Test_A_Pol: { key: '_Test_A_Pol', ele: 'anemo', weaponType: 'polearm'},
  _Test_G_Pol: { key: '_Test_G_Pol', ele: 'geo', weaponType: 'polearm'},
  _Test_E_Pol: { key: '_Test_E_Pol', ele: 'electro', weaponType: 'polearm'},
  _Test_D_Pol: { key: '_Test_D_Pol', ele: 'dendro', weaponType: 'polearm'},
  _Test_H_Pol: { key: '_Test_H_Pol', ele: 'hydro', weaponType: 'polearm'},
  _Test_P_Pol: { key: '_Test_P_Pol', ele: 'pyro', weaponType: 'polearm'},
  _Test_C_Pol: { key: '_Test_C_Pol', ele: 'cryo', weaponType: 'polearm'},
  _Test_A_Cat: { key: '_Test_A_Cat', ele: 'anemo', weaponType: 'catalyst'},
  _Test_G_Cat: { key: '_Test_G_Cat', ele: 'geo', weaponType: 'catalyst'},
  _Test_E_Cat: { key: '_Test_E_Cat', ele: 'electro', weaponType: 'catalyst'},
  _Test_D_Cat: { key: '_Test_D_Cat', ele: 'dendro', weaponType: 'catalyst'},
  _Test_H_Cat: { key: '_Test_H_Cat', ele: 'hydro', weaponType: 'catalyst'},
  _Test_P_Cat: { key: '_Test_P_Cat', ele: 'pyro', weaponType: 'catalyst'},
  _Test_C_Cat: { key: '_Test_C_Cat', ele: 'cryo', weaponType: 'catalyst'},
  _Test_A_Bow: { key: '_Test_A_Bow', ele: 'anemo', weaponType: 'bow'},
  _Test_G_Bow: { key: '_Test_G_Bow', ele: 'geo', weaponType: 'bow'},
  _Test_E_Bow: { key: '_Test_E_Bow', ele: 'electro', weaponType: 'bow'},
  _Test_D_Bow: { key: '_Test_D_Bow', ele: 'dendro', weaponType: 'bow'},
  _Test_H_Bow: { key: '_Test_H_Bow', ele: 'hydro', weaponType: 'bow'},
  _Test_P_Bow: { key: '_Test_P_Bow', ele: 'pyro', weaponType: 'bow'},
  _Test_C_Bow: { key: '_Test_C_Bow', ele: 'cryo', weaponType: 'bow'},
};
